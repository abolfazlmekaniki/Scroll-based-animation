 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Fc,Yn,tr,qo,gi,Bc,Yo,sv=function(){return typeof window<"u"},Bn={},pi=180/Math.PI,er=Math.PI/180,qi=Math.atan2,zc=1e8,$o=/([A-Z])/g,av=/(left|right|width|margin|padding|x)/i,ov=/[\s,\(]\S/,Sn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},_o=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},lv=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},cv=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},hv=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},fu=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},pu=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},uv=function(t,e,n){return t.style[e]=n},dv=function(t,e,n){return t.style.setProperty(e,n)},fv=function(t,e,n){return t._gsap[e]=n},pv=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},mv=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},_v=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},Jt="transform",Ge=Jt+"Origin",gv=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in Bn&&s){if(this.tfm=this.tfm||{},t!=="transform")t=Sn[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=Un(i,o)}):this.tfm[t]=a.x?a[t]:Un(i,t),t===Ge&&(this.tfm.zOrigin=a.zOrigin);else return Sn.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(Jt)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Ge,e,"")),t=Jt}(s||e)&&this.props.push(t,e,s[t])},mu=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},vv=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace($o,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=Yo(),(!s||!s.isStart)&&!n[Jt]&&(mu(n),i.zOrigin&&n[Ge]&&(n[Ge]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},_u=function(t,e){var n={target:t,props:[],revert:vv,save:gv};return t._gsap||Ve.core.getCache(t),e&&e.split(",").forEach(function(i){return n.save(i)}),n},gu,go=function(t,e){var n=Yn.createElementNS?Yn.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):Yn.createElement(t);return n&&n.style?n:Yn.createElement(t)},yn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace($o,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,hr(e)||e,1)||""},Gc="O,Moz,ms,Ms,Webkit".split(","),hr=function(t,e,n){var i=e||gi,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(Gc[a]+t in s););return a<0?null:(a===3?"ms":a>=0?Gc[a]:"")+t},vo=function(){sv()&&window.document&&(Fc=window,Yn=Fc.document,tr=Yn.documentElement,gi=go("div")||{style:{}},go("div"),Jt=hr(Jt),Ge=Jt+"Origin",gi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",gu=!!hr("perspective"),Yo=Ve.core.reverting,qo=1)},ka=function r(t){var e=go("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(tr.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),tr.removeChild(e),this.style.cssText=s,a},Vc=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},vu=function(t){var e;try{e=t.getBBox()}catch{e=ka.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===ka||(e=ka.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+Vc(t,["x","cx","x1"])||0,y:+Vc(t,["y","cy","y1"])||0,width:0,height:0}:e},xu=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&vu(t))},Ri=function(t,e){if(e){var n=t.style,i;e in Bn&&e!==Ge&&(e=Jt),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace($o,"-$1").toLowerCase())):n.removeAttribute(e)}},$n=function(t,e,n,i,s,a){var o=new ze(t._pt,e,n,0,1,a?pu:fu);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},Hc={deg:1,rad:1,turn:1},xv={grid:1,flex:1},ni=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=gi.style,l=av.test(e),c=t.tagName.toLowerCase()==="svg",h=(c?"client":"offset")+(l?"Width":"Height"),u=100,d=i==="px",m=i==="%",g,_,p,f;if(i===a||!s||Hc[i]||Hc[a])return s;if(a!=="px"&&!d&&(s=r(t,e,n,"px")),f=t.getCTM&&xu(t),(m||a==="%")&&(Bn[e]||~e.indexOf("adius")))return g=f?t.getBBox()[l?"width":"height"]:t[h],re(m?s/g*u:s/100*g);if(o[l?"width":"height"]=u+(d?a:i),_=~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,f&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===Yn||!_.appendChild)&&(_=Yn.body),p=_._gsap,p&&m&&p.width&&l&&p.time===$e.time&&!p.uncache)return re(s/p.width*u);if(m&&(e==="height"||e==="width")){var M=t.style[e];t.style[e]=u+i,g=t[h],M?t.style[e]=M:Ri(t,e)}else(m||a==="%")&&!xv[yn(_,"display")]&&(o.position=yn(t,"position")),_===t&&(o.position="static"),_.appendChild(gi),g=gi[h],_.removeChild(gi),o.position="absolute";return l&&m&&(p=Si(_),p.time=$e.time,p.width=_[h]),re(d?g*s/u:g&&s?u/g*s:0)},Un=function(t,e,n,i){var s;return qo||vo(),e in Sn&&e!=="transform"&&(e=Sn[e],~e.indexOf(",")&&(e=e.split(",")[0])),Bn[e]&&e!=="transform"?(s=kr(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Gs(yn(t,Ge))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=zs[e]&&zs[e](t,e,n)||yn(t,e)||Nh(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ni(t,e,s,n)+n:s},Mv=function(t,e,n,i){if(!n||n==="none"){var s=hr(e,t,1),a=s&&yn(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=yn(t,"borderTopColor"))}var o=new ze(this._pt,t.style,e,0,1,hu),l=0,c=0,h,u,d,m,g,_,p,f,M,x,S,y;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(_=t.style[e],t.style[e]=i,i=yn(t,e)||i,_?t.style[e]=_:Ri(t,e)),h=[n,i],tu(h),n=h[0],i=h[1],d=n.match($i)||[],y=i.match($i)||[],y.length){for(;u=$i.exec(i);)p=u[0],M=i.substring(l,u.index),g?g=(g+1)%5:(M.substr(-5)==="rgba("||M.substr(-5)==="hsla(")&&(g=1),p!==(_=d[c++]||"")&&(m=parseFloat(_)||0,S=_.substr((m+"").length),p.charAt(1)==="="&&(p=Qi(m,p)+S),f=parseFloat(p),x=p.substr((f+"").length),l=$i.lastIndex-x.length,x||(x=x||Ke.units[e]||S,l===i.length&&(i+=x,o.e+=x)),S!==x&&(m=ni(t,e,_,x)||0),o._pt={_next:o._pt,p:M||c===1?M:",",s:m,c:f-m,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?pu:fu;return Ch.test(i)&&(o.e=0),this._pt=o,o},kc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},Sv=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=kc[n]||n,e[1]=kc[i]||i,e.join(" ")},Ev=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],Bn[o]&&(l=1,o=o==="transformOrigin"?Ge:Jt),Ri(n,o);l&&(Ri(n,Jt),a&&(a.svg&&n.removeAttribute("transform"),kr(n,1),a.uncache=1,mu(i)))}},zs={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new ze(t._pt,e,n,0,0,Ev);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},Hr=[1,0,0,1,0,0],Mu={},Su=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},Wc=function(t){var e=yn(t,Jt);return Su(e)?Hr:e.substr(7).match(Rh).map(re)},jo=function(t,e){var n=t._gsap||Si(t),i=t.style,s=Wc(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?Hr:s):(s===Hr&&!t.offsetParent&&t!==tr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(c=1,o=t.nextElementSibling,tr.appendChild(t)),s=Wc(t),l?i.display=l:Ri(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):tr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},xo=function(t,e,n,i,s,a){var o=t._gsap,l=s||jo(t,!0),c=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,d=o.yOffset||0,m=l[0],g=l[1],_=l[2],p=l[3],f=l[4],M=l[5],x=e.split(" "),S=parseFloat(x[0])||0,y=parseFloat(x[1])||0,w,A,C,v;n?l!==Hr&&(A=m*p-g*_)&&(C=S*(p/A)+y*(-_/A)+(_*M-p*f)/A,v=S*(-g/A)+y*(m/A)-(m*M-g*f)/A,S=C,y=v):(w=vu(t),S=w.x+(~x[0].indexOf("%")?S/100*w.width:S),y=w.y+(~(x[1]||x[0]).indexOf("%")?y/100*w.height:y)),i||i!==!1&&o.smooth?(f=S-c,M=y-h,o.xOffset=u+(f*m+M*_)-f,o.yOffset=d+(f*g+M*p)-M):o.xOffset=o.yOffset=0,o.xOrigin=S,o.yOrigin=y,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[Ge]="0px 0px",a&&($n(a,o,"xOrigin",c,S),$n(a,o,"yOrigin",h,y),$n(a,o,"xOffset",u,o.xOffset),$n(a,o,"yOffset",d,o.yOffset)),t.setAttribute("data-svg-origin",S+" "+y)},kr=function(t,e){var n=t._gsap||new ru(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=yn(t,Ge)||"0",h,u,d,m,g,_,p,f,M,x,S,y,w,A,C,v,b,F,B,q,P,N,X,W,K,j,$,D,V,at,st,lt;return h=u=d=_=p=f=M=x=S=0,m=g=1,n.svg=!!(t.getCTM&&xu(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Jt]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Jt]!=="none"?l[Jt]:"")),i.scale=i.rotate=i.translate="none"),A=jo(t,n.svg),n.svg&&(n.uncache?(K=t.getBBox(),c=n.xOrigin-K.x+"px "+(n.yOrigin-K.y)+"px",W=""):W=!e&&t.getAttribute("data-svg-origin"),xo(t,W||c,!!W||n.originIsAbsolute,n.smooth!==!1,A)),y=n.xOrigin||0,w=n.yOrigin||0,A!==Hr&&(F=A[0],B=A[1],q=A[2],P=A[3],h=N=A[4],u=X=A[5],A.length===6?(m=Math.sqrt(F*F+B*B),g=Math.sqrt(P*P+q*q),_=F||B?qi(B,F)*pi:0,M=q||P?qi(q,P)*pi+_:0,M&&(g*=Math.abs(Math.cos(M*er))),n.svg&&(h-=y-(y*F+w*q),u-=w-(y*B+w*P))):(lt=A[6],at=A[7],$=A[8],D=A[9],V=A[10],st=A[11],h=A[12],u=A[13],d=A[14],C=qi(lt,V),p=C*pi,C&&(v=Math.cos(-C),b=Math.sin(-C),W=N*v+$*b,K=X*v+D*b,j=lt*v+V*b,$=N*-b+$*v,D=X*-b+D*v,V=lt*-b+V*v,st=at*-b+st*v,N=W,X=K,lt=j),C=qi(-q,V),f=C*pi,C&&(v=Math.cos(-C),b=Math.sin(-C),W=F*v-$*b,K=B*v-D*b,j=q*v-V*b,st=P*b+st*v,F=W,B=K,q=j),C=qi(B,F),_=C*pi,C&&(v=Math.cos(C),b=Math.sin(C),W=F*v+B*b,K=N*v+X*b,B=B*v-F*b,X=X*v-N*b,F=W,N=K),p&&Math.abs(p)+Math.abs(_)>359.9&&(p=_=0,f=180-f),m=re(Math.sqrt(F*F+B*B+q*q)),g=re(Math.sqrt(X*X+lt*lt)),C=qi(N,X),M=Math.abs(C)>2e-4?C*pi:0,S=st?1/(st<0?-st:st):0),n.svg&&(W=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Su(yn(t,Jt)),W&&t.setAttribute("transform",W))),Math.abs(M)>90&&Math.abs(M)<270&&(s?(m*=-1,M+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,M+=M<=0?180:-180)),e=e||n.uncache,n.x=h-((n.xPercent=h&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-h)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-u)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=re(m),n.scaleY=re(g),n.rotation=re(_)+o,n.rotationX=re(p)+o,n.rotationY=re(f)+o,n.skewX=M+o,n.skewY=x+o,n.transformPerspective=S+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[Ge]=Gs(c)),n.xOffset=n.yOffset=0,n.force3D=Ke.force3D,n.renderTransform=n.svg?Tv:gu?Eu:yv,n.uncache=0,n},Gs=function(t){return(t=t.split(" "))[0]+" "+t[1]},Wa=function(t,e,n){var i=Te(e);return re(parseFloat(e)+parseFloat(ni(t,"x",n+"px",i)))+i},yv=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Eu(t,e)},hi="0deg",yr="0px",ui=") ",Eu=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,h=n.rotationY,u=n.rotationX,d=n.skewX,m=n.skewY,g=n.scaleX,_=n.scaleY,p=n.transformPerspective,f=n.force3D,M=n.target,x=n.zOrigin,S="",y=f==="auto"&&t&&t!==1||f===!0;if(x&&(u!==hi||h!==hi)){var w=parseFloat(h)*er,A=Math.sin(w),C=Math.cos(w),v;w=parseFloat(u)*er,v=Math.cos(w),a=Wa(M,a,A*v*-x),o=Wa(M,o,-Math.sin(w)*-x),l=Wa(M,l,C*v*-x+x)}p!==yr&&(S+="perspective("+p+ui),(i||s)&&(S+="translate("+i+"%, "+s+"%) "),(y||a!==yr||o!==yr||l!==yr)&&(S+=l!==yr||y?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+ui),c!==hi&&(S+="rotate("+c+ui),h!==hi&&(S+="rotateY("+h+ui),u!==hi&&(S+="rotateX("+u+ui),(d!==hi||m!==hi)&&(S+="skew("+d+", "+m+ui),(g!==1||_!==1)&&(S+="scale("+g+", "+_+ui),M.style[Jt]=S||"translate(0, 0)"},Tv=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,h=n.skewY,u=n.scaleX,d=n.scaleY,m=n.target,g=n.xOrigin,_=n.yOrigin,p=n.xOffset,f=n.yOffset,M=n.forceCSS,x=parseFloat(a),S=parseFloat(o),y,w,A,C,v;l=parseFloat(l),c=parseFloat(c),h=parseFloat(h),h&&(h=parseFloat(h),c+=h,l+=h),l||c?(l*=er,c*=er,y=Math.cos(l)*u,w=Math.sin(l)*u,A=Math.sin(l-c)*-d,C=Math.cos(l-c)*d,c&&(h*=er,v=Math.tan(c-h),v=Math.sqrt(1+v*v),A*=v,C*=v,h&&(v=Math.tan(h),v=Math.sqrt(1+v*v),y*=v,w*=v)),y=re(y),w=re(w),A=re(A),C=re(C)):(y=u,C=d,w=A=0),(x&&!~(a+"").indexOf("px")||S&&!~(o+"").indexOf("px"))&&(x=ni(m,"x",a,"px"),S=ni(m,"y",o,"px")),(g||_||p||f)&&(x=re(x+g-(g*y+_*A)+p),S=re(S+_-(g*w+_*C)+f)),(i||s)&&(v=m.getBBox(),x=re(x+i/100*v.width),S=re(S+s/100*v.height)),v="matrix("+y+","+w+","+A+","+C+","+x+","+S+")",m.setAttribute("transform",v),M&&(m.style[Jt]=v)},Av=function(t,e,n,i,s){var a=360,o=ge(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?pi:1),c=l-i,h=i+c+"deg",u,d;return o&&(u=s.split("_")[1],u==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),u==="cw"&&c<0?c=(c+a*zc)%a-~~(c/a)*a:u==="ccw"&&c>0&&(c=(c-a*zc)%a-~~(c/a)*a)),t._pt=d=new ze(t._pt,e,n,i,c,lv),d.e=h,d.u="deg",t._props.push(n),d},Xc=function(t,e){for(var n in e)t[n]=e[n];return t},bv=function(t,e,n){var i=Xc({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,h,u,d,m,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[Jt]=e,o=kr(n,1),Ri(n,Jt),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Jt],a[Jt]=e,o=kr(n,1),a[Jt]=c);for(l in Bn)c=i[l],h=o[l],c!==h&&s.indexOf(l)<0&&(m=Te(c),g=Te(h),u=m!==g?ni(n,l,c,g):parseFloat(c),d=parseFloat(h),t._pt=new ze(t._pt,o,l,u,d-u,_o),t._pt.u=g||0,t._props.push(l));Xc(o,i)};Be("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});zs[t>1?"border"+r:r]=function(o,l,c,h,u){var d,m;if(arguments.length<4)return d=a.map(function(g){return Un(o,g,c)}),m=d.join(" "),m.split(d[0]).length===5?d[0]:m;d=(h+"").split(" "),m={},a.forEach(function(g,_){return m[g]=d[_]=d[_]||d[(_-1)/2|0]}),o.init(l,m,u)}});var yu={name:"css",register:vo,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,h,u,d,m,g,_,p,f,M,x,S,y,w,A,C;qo||vo(),this.styles=this.styles||_u(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(h=e[_],!(Ye[_]&&su(_,e,n,i,t,s)))){if(m=typeof h,g=zs[_],m==="function"&&(h=h.call(n,i,t,s),m=typeof h),m==="string"&&~h.indexOf("random(")&&(h=zr(h)),g)g(this,t,_,h,n)&&(A=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),h+="",Qn.lastIndex=0,Qn.test(c)||(p=Te(c),f=Te(h)),f?p!==f&&(c=ni(t,_,c,f)+f):p&&(h+=p),this.add(o,"setProperty",c,h,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(m!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],ge(c)&&~c.indexOf("random(")&&(c=zr(c)),Te(c+"")||c==="auto"||(c+=Ke.units[_]||Te(Un(t,_))||""),(c+"").charAt(1)==="="&&(c=Un(t,_))):c=Un(t,_),d=parseFloat(c),M=m==="string"&&h.charAt(1)==="="&&h.substr(0,2),M&&(h=h.substr(2)),u=parseFloat(h),_ in Sn&&(_==="autoAlpha"&&(d===1&&Un(t,"visibility")==="hidden"&&u&&(d=0),C.push("visibility",0,o.visibility),$n(this,o,"visibility",d?"inherit":"hidden",u?"inherit":"hidden",!u)),_!=="scale"&&_!=="transform"&&(_=Sn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),x=_ in Bn,x){if(this.styles.save(_),S||(y=t._gsap,y.renderTransform&&!e.parseTransform||kr(t,e.parseTransform),w=e.smoothOrigin!==!1&&y.smooth,S=this._pt=new ze(this._pt,o,Jt,0,1,y.renderTransform,y,0,-1),S.dep=1),_==="scale")this._pt=new ze(this._pt,y,"scaleY",y.scaleY,(M?Qi(y.scaleY,M+u):u)-y.scaleY||0,_o),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(Ge,0,o[Ge]),h=Sv(h),y.svg?xo(t,h,0,w,0,this):(f=parseFloat(h.split(" ")[2])||0,f!==y.zOrigin&&$n(this,y,"zOrigin",y.zOrigin,f),$n(this,o,_,Gs(c),Gs(h)));continue}else if(_==="svgOrigin"){xo(t,h,1,w,0,this);continue}else if(_ in Mu){Av(this,y,_,d,M?Qi(d,M+h):h);continue}else if(_==="smoothOrigin"){$n(this,y,"smooth",y.smooth,h);continue}else if(_==="force3D"){y[_]=h;continue}else if(_==="transform"){bv(this,h,t);continue}}else _ in o||(_=hr(_)||_);if(x||(u||u===0)&&(d||d===0)&&!ov.test(h)&&_ in o)p=(c+"").substr((d+"").length),u||(u=0),f=Te(h)||(_ in Ke.units?Ke.units[_]:p),p!==f&&(d=ni(t,_,c,f)),this._pt=new ze(this._pt,x?y:o,_,d,(M?Qi(d,M+u):u)-d,!x&&(f==="px"||_==="zIndex")&&e.autoRound!==!1?hv:_o),this._pt.u=f||0,p!==f&&f!=="%"&&(this._pt.b=c,this._pt.r=cv);else if(_ in o)Mv.call(this,t,_,c,M?M+h:h);else if(_ in t)this.add(t,_,c||t[_],M?M+h:h,i,s);else if(_!=="parseTransform"){Fo(_,h);continue}x||(_ in o?C.push(_,0,o[_]):C.push(_,1,c||t[_])),a.push(_)}}A&&uu(this)},render:function(t,e){if(e.tween._time||!Yo())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Un,aliases:Sn,getSetter:function(t,e,n){var i=Sn[e];return i&&i.indexOf(",")<0&&(e=i),e in Bn&&e!==Ge&&(t._gsap.x||Un(t,"x"))?n&&Bc===n?e==="scale"?pv:fv:(Bc=n||{})&&(e==="scale"?mv:_v):t.style&&!Io(t.style[e])?uv:~e.indexOf("-")?dv:Wo(t,e)},core:{_removeProperty:Ri,_getMatrix:jo}};Ve.utils.checkPrefix=hr;Ve.core.getStyleSaver=_u;(function(r,t,e,n){var i=Be(r+","+t+","+e,function(s){Bn[s]=1});Be(t,function(s){Ke.units[s]="deg",Mu[s]=1}),Sn[i[13]]=r+","+t,Be(n,function(s){var a=s.split(":");Sn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Be("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Ke.units[r]="px"});Ve.registerPlugin(yu);var Tu=Ve.registerPlugin(yu)||Ve;Tu.core.Tween;const wv=new d0,Dr={materialColor:"#ffeded"};wv.addColor(Dr,"materialColor").onFinishChange(()=>{js.color.set(Dr.materialColor),Cu.color.set(Dr.materialColor)});const Rv=document.querySelector("canvas.webgl"),Kr=new Hg,Cv=new $g,Au=Cv.load("textures/gradients/3.jpg");Au.magFilter=ye;const js=new Wg({color:Dr.materialColor,gradientMap:Au}),ur=4,Ks=new mn(new Co(1,.4,16,60),js),Zs=new mn(new Ro(1,2,32),js),Js=new mn(new Po(.8,.35,100,16),js);Ks.position.y=-ur*0;Zs.position.y=-ur*1;Js.position.y=-ur*2;Ks.position.x=2;Zs.position.x=-2;Js.position.x=2;Kr.add(Ks,Zs,Js);const Ko=[Ks,Zs,Js],bu=new Jg(16777215,3);bu.position.set(1,1,0);Kr.add(bu);const Ie={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{Ie.width=window.innerWidth,Ie.height=window.innerHeight,fr.aspect=Ie.width/Ie.height,fr.updateProjectionMatrix(),Wr.setSize(Ie.width,Ie.height),Wr.setPixelRatio(Math.min(window.devicePixelRatio,2))});const dr={};dr.x=0;dr.y=0;window.addEventListener("mousemove",r=>{dr.x=r.clientX/Ie.width-.5,dr.y=r.clientY/Ie.height-.5});const Ki=new Ar;Kr.add(Ki);const wu=200,Rs=new Float32Array(wu*3);for(let r=0;r<wu;r++)Rs[r*3+0]=(Math.random()-.5)*10,Rs[r*3+1]=ur*.5-Math.random()*ur*Ko.length,Rs[r*3+2]=(Math.random()-.5)*10;const Ru=new ln;Ru.setAttribute("position",new _n(Rs,3));const Cu=new Th({color:Dr.materialColor,sizeAttenuation:!0,size:.03}),Pv=new kg(Ru,Cu);Kr.add(Pv);const fr=new nn(35,Ie.width/Ie.height,.1,100);fr.position.z=6;Ki.add(fr);const Wr=new yh({canvas:Rv,alpha:!0});Wr.setSize(Ie.width,Ie.height);Wr.setPixelRatio(Math.min(window.devicePixelRatio,2));let Mo=window.scrollY,Xa=0;window.addEventListener("scroll",()=>{Mo=window.scrollY;const r=Math.round(Mo/Ie.height);r!=Xa&&(Xa=r,Tu.to(Ko[Xa].rotation,{duration:1.5,ease:"power2.inOut",x:"+=6",y:"+=3",z:"+=1.5"}))});const Lv=new Qg;let qc=0;const Pu=()=>{const r=Lv.getElapsedTime(),t=r-qc;qc=r,fr.position.y=-Mo/Ie.height*ur;const e=dr.x,n=-dr.y;Ki.position.x+=(e-Ki.position.x)*t,Ki.position.y+=(n-Ki.position.y)*t;for(const i of Ko)i.rotation.x+=t*.5,i.rotation.y+=t*.5;Wr.render(Kr,fr),window.requestAnimationFrame(Pu)};Pu();
//# sourceMappingURL=index-a8136feb.js.map
